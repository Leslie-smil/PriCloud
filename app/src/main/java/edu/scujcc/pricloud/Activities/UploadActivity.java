...
import edu.scujcc.pricloud.Permission.KbPermission;
import edu.scujcc.pricloud.Permission.KbPermissionListener;
import edu.scujcc.pricloud.Permission.KbPermissionUtils;
...
// task.cancel(); // 可以取消任务。
    ...
    public static String getPath(final Context context, final Uri uri) {
        ...
        // MyOSSFile
        else if ("myOSSFile".equalsIgnoreCase(uri.getScheme())) {
            return uri.getPath();
        }
    ...
    private void chooseFile() {
        ...
        try {
            startActivityForResult(Intent.createChooser(intent, "Choose MyOSSFile"), CHOOSE_FILE_CODE);
